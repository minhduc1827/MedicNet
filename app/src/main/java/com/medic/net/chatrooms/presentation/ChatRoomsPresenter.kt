...
import com.medic.net.helper.ChatRoomsSortOrder
import com.medic.net.helper.Constants
import com.medic.net.helper.SharedPreferenceHelper
...
import com.medic.net.server.domain.GetActiveUsersInteractor
...
import com.medic.net.server.domain.SaveActiveUsersInteractor
import com.medic.net.server.domain.SaveChatRoomsInteractor
import com.medic.net.server.domain.SettingsRepository
import com.medic.net.server.domain.hasShowLastMessage
import com.medic.net.server.domain.showLastMessage
import com.medic.net.server.domain.useRealName
import com.medic.net.server.infraestructure.ConnectionManager
import com.medic.net.server.infraestructure.ConnectionManagerFactory
import com.medic.net.server.infraestructure.chatRooms
